...
export const AboutWithContactBlueprint1: React.FC<AboutWithContactBlueprintProps> = (props) => {
  const blueprintClasses = useBlueprintStyles({
    h: props.aboutWithContact.h,
    x: props.aboutWithContact.x,
    y: props.aboutWithContact.y,
    w: props.aboutWithContact.w,
    bgColor: props.aboutWithContact.data.style.bgColor,
    textColor: props.aboutWithContact.data.style.textColor,
  });
